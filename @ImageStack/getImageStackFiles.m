...
% GUI for loading and mixing up to 3 image stacks
    ...
    obj.ch1.colourlist=uicontrol(obj.fhandle,'Style','listbox',...
        ...
        {@ImageStack.ColourListCallback,obj},'TooltipString','Select Colour');
    
    obj.ch1.UniformIlluminationButton=uicontrol(obj.fhandle,'Style','pushbutton',...
        'Position',[115,figheight-120,53,53],'String','Correct',...
        'FontSize',10,'Callback',@ImageStack.CorrectCh1Illum,'TooltipString','Correct illumination if uneven',...
        'Enable','off');
    ...
    obj.ch1.filesList=uicontrol(obj.fhandle,'Style','listbox',...
        ...
        'TooltipString','Select image to display');
    ...
    obj.ch1.loadPB=uicontrol(obj.fhandle,'Style','pushbutton',...
        'String','Ch1 images','Position',[15,figheight-40,100,30],...
        'FontSize',10,'Callback',{@ImageStack.LoadCh1,obj},'Tag','LoadCh1PB');
    % calculate y offset
    ...
    obj.ch2.colourlist=uicontrol(obj.fhandle,'Style','listbox',...
        ...
        {'phase/DIC','green','red','blue','yellow'},...
        'FontSize',10,'Callback',{@ImageStack.ColourListCallback,obj});
    
     obj.ch2.UniformIlluminationButton=uicontrol(obj.fhandle,'Style','pushbutton',...
        'Position',[115,figheight-120-y_offset,53,53],'String','Correct',...
        'FontSize',10,'Callback',@ImageStack.CorrectCh2Illum,'TooltipString','Correct illumination if uneven',...
        'Enable','off');
   ...
   % set up Java dual range slider
    ...
    obj.ch2.loadPB=uicontrol(obj.fhandle,'Style','pushbutton',...
        ...
        'FontSize',10,'Callback',{@ImageStack.LoadCh2,obj},'Enable','off');
    % channel 3
    ...
    obj.ch3.UniformIlluminationButton=uicontrol(obj.fhandle,'Style','pushbutton',...
        'Position',[115,figheight-120-2*y_offset,53,53],'String','Correct',...
        'FontSize',10,'Callback',@ImageStack.CorrectCh3Illum,'TooltipString','Correct illumination if uneven',...
        'Enable','off');
    ...
    obj.ch3.loadPB=uicontrol(obj.fhandle,'Style','pushbutton',...
        ...
        'FontSize',10,'Callback',{@ImageStack.LoadCh3,obj},'Enable','off');
